...
pub fn deployments_tags_create(configuration: &configuration::Configuration, request_id: &str, payload: models::DeploymentTagPayload) -> Result<models::DeploymentTagResponse, Error<DeploymentsTagsCreateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/deployments/{request_id}/tags", local_var_configuration.base_path, request_id=crate::apis::urlencode(request_id));
...
pub fn deployments_tags_delete(configuration: &configuration::Configuration, request_id: &str, tag_name: &str) -> Result<(), Error<DeploymentsTagsDeleteError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/deployments/{request_id}/tags/{tag_name}", local_var_configuration.base_path, request_id=crate::apis::urlencode(request_id), tag_name=crate::apis::urlencode(tag_name));
...
pub fn deployments_tags_list(configuration: &configuration::Configuration, request_id: &str) -> Result<models::DeploymentTagListResponse, Error<DeploymentsTagsListError>> {
    let local_var_configuration = configuration;
...
pub fn deployments_tags_read(configuration: &configuration::Configuration, request_id: &str, tag_name: &str) -> Result<models::DeploymentTagResponse, Error<DeploymentsTagsReadError>> {
    let local_var_configuration = configuration;
...
pub fn deployments_tags_update(configuration: &configuration::Configuration, request_id: &str, tag_name: &str, payload: models::DeploymentTagPayload) -> Result<models::DeploymentTagResponse, Error<DeploymentsTagsUpdateError>> {
    let local_var_configuration = configuration;
