...
/// Delete a matchmaker.
pub fn delete_matchmaker(configuration: &configuration::Configuration, matchmaker_name: &str) -> Result<(), Error<DeleteMatchmakerError>> {
...
pub fn delete_matchmaker_component(configuration: &configuration::Configuration, component_name: &str) -> Result<(), Error<DeleteMatchmakerComponentError>> {
    let local_var_configuration = configuration;
...
pub fn delete_matchmaker_component_env(configuration: &configuration::Configuration, component_name: &str, env_key: &str) -> Result<(), Error<DeleteMatchmakerComponentEnvError>> {
    let local_var_configuration = configuration;
...
pub fn delete_matchmaker_managed_release(configuration: &configuration::Configuration, matchmaker_name: &str, release_version: &str) -> Result<(), Error<DeleteMatchmakerManagedReleaseError>> {
    let local_var_configuration = configuration;
...
pub fn delete_matchmaker_release(configuration: &configuration::Configuration, matchmaker_name: &str, release_version: &str) -> Result<(), Error<DeleteMatchmakerReleaseError>> {
    let local_var_configuration = configuration;
...
pub fn delete_matchmaker_release_config(configuration: &configuration::Configuration, config_name: &str) -> Result<(), Error<DeleteMatchmakerReleaseConfigError>> {
    let local_var_configuration = configuration;
...
pub fn get_component_list(configuration: &configuration::Configuration, ) -> Result<models::MatchmakerComponentListResponse, Error<GetComponentListError>> {
    let local_var_configuration = configuration;
...
pub fn get_envs_list(configuration: &configuration::Configuration, component_name: &str) -> Result<models::MatchmakerComponentEnvListResponse, Error<GetEnvsListError>> {
    let local_var_configuration = configuration;
...
pub fn get_matchmaker(configuration: &configuration::Configuration, matchmaker_name: &str) -> Result<models::MatchmakerResponse, Error<GetMatchmakerError>> {
    let local_var_configuration = configuration;
...
pub fn get_matchmaker_component(configuration: &configuration::Configuration, component_name: &str) -> Result<models::MatchmakerComponentResponse, Error<GetMatchmakerComponentError>> {
    let local_var_configuration = configuration;
...
pub fn get_matchmaker_component_env(configuration: &configuration::Configuration, component_name: &str, env_key: &str) -> Result<models::MatchmakerComponentEnvsResponse, Error<GetMatchmakerComponentEnvError>> {
    let local_var_configuration = configuration;
...
pub fn get_matchmaker_list(configuration: &configuration::Configuration, ) -> Result<models::MatchmakerListResponse, Error<GetMatchmakerListError>> {
    let local_var_configuration = configuration;
...
pub fn get_matchmaker_managed_release(configuration: &configuration::Configuration, matchmaker_name: &str, release_version: &str) -> Result<models::MatchmakerManagedReleaseResponse, Error<GetMatchmakerManagedReleaseError>> {
    let local_var_configuration = configuration;
...
pub fn get_matchmaker_release(configuration: &configuration::Configuration, matchmaker_name: &str, release_version: &str) -> Result<models::MatchmakerReleaseResponse, Error<GetMatchmakerReleaseError>> {
    let local_var_configuration = configuration;
...
pub fn get_matchmaker_release_config(configuration: &configuration::Configuration, config_name: &str) -> Result<models::MatchmakerReleaseConfigResponse, Error<GetMatchmakerReleaseConfigError>> {
    let local_var_configuration = configuration;
...
pub fn get_release_configs_list(configuration: &configuration::Configuration, ) -> Result<models::MatchmakerComponentEnvListResponse, Error<GetReleaseConfigsListError>> {
    let local_var_configuration = configuration;
...
pub fn get_release_list(configuration: &configuration::Configuration, matchmaker_name: &str) -> Result<models::MatchmakerComponentEnvListResponse, Error<GetReleaseListError>> {
    let local_var_configuration = configuration;
...
pub fn patch_matchmaker(configuration: &configuration::Configuration, matchmaker_name: &str, payload: models::MatchmakerUpdate) -> Result<models::MatchmakerResponse, Error<PatchMatchmakerError>> {
    let local_var_configuration = configuration;
...
pub fn patch_matchmaker_component(configuration: &configuration::Configuration, component_name: &str, payload: models::MatchmakerComponentUpdate) -> Result<models::MatchmakerComponentResponse, Error<PatchMatchmakerComponentError>> {
    let local_var_configuration = configuration;
...
pub fn patch_matchmaker_component_env(configuration: &configuration::Configuration, component_name: &str, env_key: &str, payload: models::MatchmakerComponentEnvsUpdate) -> Result<models::MatchmakerComponentEnvsResponse, Error<PatchMatchmakerComponentEnvError>> {
    let local_var_configuration = configuration;
...
pub fn patch_matchmaker_managed_release(configuration: &configuration::Configuration, matchmaker_name: &str, release_version: &str, payload: models::MatchmakerManagedReleaseUpdate) -> Result<models::MatchmakerManagedReleaseResponse, Error<PatchMatchmakerManagedReleaseError>> {
    let local_var_configuration = configuration;
...
pub fn patch_matchmaker_release(configuration: &configuration::Configuration, matchmaker_name: &str, release_version: &str, payload: models::MatchmakerReleaseUpdate) -> Result<models::MatchmakerReleaseResponse, Error<PatchMatchmakerReleaseError>> {
    let local_var_configuration = configuration;
...
pub fn patch_matchmaker_release_config(configuration: &configuration::Configuration, config_name: &str, payload: models::MatchmakerReleaseConfigUpdate) -> Result<models::MatchmakerReleaseConfigResponse, Error<PatchMatchmakerReleaseConfigError>> {
    let local_var_configuration = configuration;
...
pub fn post_matchmaker(configuration: &configuration::Configuration, payload: models::MatchmakerCreate) -> Result<models::MatchmakerResponse, Error<PostMatchmakerError>> {
    let local_var_configuration = configuration;
...
pub fn post_matchmaker_component(configuration: &configuration::Configuration, payload: models::MatchmakerComponentCreate) -> Result<models::MatchmakerComponentResponse, Error<PostMatchmakerComponentError>> {
    let local_var_configuration = configuration;
...
pub fn post_matchmaker_component_env(configuration: &configuration::Configuration, component_name: &str, payload: models::MatchmakerComponentEnvsCreate) -> Result<models::MatchmakerComponentEnvsResponse, Error<PostMatchmakerComponentEnvError>> {
    let local_var_configuration = configuration;
...
pub fn post_matchmaker_managed_release(configuration: &configuration::Configuration, matchmaker_name: &str, payload: models::MatchmakerManagedReleaseCreate) -> Result<models::MatchmakerManagedReleaseResponse, Error<PostMatchmakerManagedReleaseError>> {
    let local_var_configuration = configuration;
...
pub fn post_matchmaker_release(configuration: &configuration::Configuration, matchmaker_name: &str, payload: models::MatchmakerReleaseCreate) -> Result<models::MatchmakerReleaseResponse, Error<PostMatchmakerReleaseError>> {
    let local_var_configuration = configuration;
...
pub fn post_matchmaker_release_config(configuration: &configuration::Configuration, payload: models::MatchmakerReleaseConfigCreate) -> Result<models::MatchmakerReleaseConfigResponse, Error<PostMatchmakerReleaseConfigError>> {
    let local_var_configuration = configuration;
