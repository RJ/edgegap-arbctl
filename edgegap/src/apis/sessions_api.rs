...
pub fn delete_users_session(configuration: &configuration::Configuration, session_id: &str, payload: models::PatchSessionModel) -> Result<models::SessionUserContext, Error<DeleteUsersSessionError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/session/{session_id}/users", local_var_configuration.base_path, session_id=crate::apis::urlencode(session_id));
...
pub fn get_session(configuration: &configuration::Configuration, session_id: &str) -> Result<models::SessionGet, Error<GetSessionError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/session/{session_id}", local_var_configuration.base_path, session_id=crate::apis::urlencode(session_id));
...
pub fn get_users_session(configuration: &configuration::Configuration, session_id: &str) -> Result<models::SessionUserContext, Error<GetUsersSessionError>> {
    let local_var_configuration = configuration;
...
pub fn list_sessions(configuration: &configuration::Configuration, ) -> Result<models::Sessions, Error<ListSessionsError>> {
    let local_var_configuration = configuration;
...
pub fn put_users_session(configuration: &configuration::Configuration, session_id: &str, payload: models::PatchSessionModel) -> Result<models::SessionUserContext, Error<PutUsersSessionError>> {
    let local_var_configuration = configuration;
...
pub fn session_delete(configuration: &configuration::Configuration, session_id: &str) -> Result<models::SessionDelete, Error<SessionDeleteError>> {
    let local_var_configuration = configuration;
...
pub fn session_post(configuration: &configuration::Configuration, payload: models::SessionModel) -> Result<models::SessionRequest, Error<SessionPostError>> {
    let local_var_configuration = configuration;
...
pub fn sessions_bulk_stop(configuration: &configuration::Configuration, payload: models::SessionBulkStopPayload) -> Result<models::SessionBulkStopResponse, Error<SessionsBulkStopError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/sessions/bulk-stop", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
