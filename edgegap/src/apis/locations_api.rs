...
pub fn location_beacon_list(configuration: &configuration::Configuration, ) -> Result<models::LocationBeaconList, Error<LocationBeaconListError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text()?;
        let local_var_entity: Option<LocationBeaconListError> = serde_json::from_str(&local_var_content).ok();
...
pub fn locations_get(configuration: &configuration::Configuration, app: Option<&str>, version: Option<&str>, r#type: Option<&str>, tags: Option<&str>) -> Result<models::Locations, Error<LocationsGetError>> {
    let local_var_configuration = configuration;
