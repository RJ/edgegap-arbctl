...
pub fn i_p(configuration: &configuration::Configuration, ) -> Result<models::IpAddressResponse, Error<IPError>> {
...
pub fn i_p_lookup(configuration: &configuration::Configuration, ip: &str) -> Result<models::IpAddressLookupResponse, Error<IPLookupError>> {
    let local_var_configuration = configuration;
...
pub fn i_ps_lookup(configuration: &configuration::Configuration, payload: models::IpAddressesLookupPayload) -> Result<models::IpAddressesLookupResponse, Error<IPsLookupError>> {
    let local_var_configuration = configuration;
