...
pub fn context_create_deployment_tag(configuration: &configuration::Configuration, request_id: &str, security_number: i32, authorization: &str, payload: models::ContextCreateDeploymentTagRequest) -> Result<models::ContextDeploymentTagResponse, Error<ContextCreateDeploymentTagError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/context/{request_id}/{security_number}/tags", local_var_configuration.base_path, request_id=crate::apis::urlencode(request_id), security_number=security_number);
...
pub fn context_delete_deployment_tag(configuration: &configuration::Configuration, tag_name: &str, request_id: &str, security_number: i32, authorization: &str) -> Result<(), Error<ContextDeleteDeploymentTagError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/context/{request_id}/{security_number}/tags/{tag_name}", local_var_configuration.base_path, tag_name=crate::apis::urlencode(tag_name), request_id=crate::apis::urlencode(request_id), security_number=security_number);
...
pub fn context_get(configuration: &configuration::Configuration, request_id: &str, security_number: i32, authorization: &str) -> Result<models::Deployment, Error<ContextGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/context/{request_id}/{security_number}", local_var_configuration.base_path, request_id=crate::apis::urlencode(request_id), security_number=security_number);
