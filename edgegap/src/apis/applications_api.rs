...
pub fn app_version_delete(configuration: &configuration::Configuration, app_name: &str, version_name: &str) -> Result<models::AppVersionDelete, Error<AppVersionDeleteError>> {
...
pub fn app_version_get(configuration: &configuration::Configuration, app_name: &str, version_name: &str) -> Result<models::AppVersionPayload, Error<AppVersionGetError>> {
    let local_var_configuration = configuration;
...
pub fn app_version_post(configuration: &configuration::Configuration, app_name: &str, payload: models::AppVersionPayload) -> Result<models::AppVersionCreateResponse, Error<AppVersionPostError>> {
    let local_var_configuration = configuration;
...
pub fn app_version_whitelist_entry_delete(configuration: &configuration::Configuration, app_name: &str, version_name: &str, entry_id: &str) -> Result<models::AppVersionWhitelistEntrySuccess, Error<AppVersionWhitelistEntryDeleteError>> {
    let local_var_configuration = configuration;
...
pub fn app_version_whitelist_entry_get(configuration: &configuration::Configuration, app_name: &str, version_name: &str, entry_id: &str) -> Result<models::AppVersionWhitelistEntry, Error<AppVersionWhitelistEntryGetError>> {
    let local_var_configuration = configuration;
...
pub fn app_version_whitelist_get(configuration: &configuration::Configuration, app_name: &str, version_name: &str) -> Result<models::AppVersionWhitelistResponse, Error<AppVersionWhitelistGetError>> {
    let local_var_configuration = configuration;
...
pub fn app_version_whitelist_post(configuration: &configuration::Configuration, app_name: &str, version_name: &str, payload: models::AppVersionWhitelistEntryPayload) -> Result<models::AppVersionWhitelistEntrySuccess, Error<AppVersionWhitelistPostError>> {
    let local_var_configuration = configuration;
...
pub fn app_versions_get(configuration: &configuration::Configuration, app_name: &str) -> Result<models::AppVersionList, Error<AppVersionsGetError>> {
    let local_var_configuration = configuration;
...
pub fn app_versions_patch(configuration: &configuration::Configuration, app_name: &str, version_name: &str, payload: models::AppVersionUpdatePayload) -> Result<models::AppVersionUpdateResponse, Error<AppVersionsPatchError>> {
    let local_var_configuration = configuration;
...
pub fn application_delete(configuration: &configuration::Configuration, app_name: &str) -> Result<(), Error<ApplicationDeleteError>> {
    let local_var_configuration = configuration;
...
pub fn application_get(configuration: &configuration::Configuration, app_name: &str) -> Result<models::Application, Error<ApplicationGetError>> {
    let local_var_configuration = configuration;
...
pub fn application_patch(configuration: &configuration::Configuration, app_name: &str, payload: models::ApplicationPatch) -> Result<models::Application, Error<ApplicationPatchError>> {
    let local_var_configuration = configuration;
...
pub fn application_post(configuration: &configuration::Configuration, payload: models::ApplicationPost) -> Result<models::Application, Error<ApplicationPostError>> {
    let local_var_configuration = configuration;
...
pub fn applications_get(configuration: &configuration::Configuration, ) -> Result<models::Applications, Error<ApplicationsGetError>> {
    let local_var_configuration = configuration;
