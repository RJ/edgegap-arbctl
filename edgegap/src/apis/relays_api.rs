...
pub fn relay_session_create(configuration: &configuration::Configuration, payload: models::RelaySessionCreatePayload) -> Result<models::RelaySessionBaseResponse, Error<RelaySessionCreateError>> {
...
pub fn relay_session_delete(configuration: &configuration::Configuration, session_id: &str) -> Result<(), Error<RelaySessionDeleteError>> {
    let local_var_configuration = configuration;
...
pub fn relay_session_get(configuration: &configuration::Configuration, session_id: &str) -> Result<models::RelaySessionBaseResponse, Error<RelaySessionGetError>> {
    let local_var_configuration = configuration;
...
pub fn relay_session_list(configuration: &configuration::Configuration, ) -> Result<models::RelaySessionListResponse, Error<RelaySessionListError>> {
    let local_var_configuration = configuration;
...
pub fn relay_user_authorize(configuration: &configuration::Configuration, payload: models::RelayUserAuthorizePayload) -> Result<models::RelaySessionUserBaseResponse, Error<RelayUserAuthorizeError>> {
    let local_var_configuration = configuration;
...
/// Authorize a user on a Relay Session
pub fn relay_user_revoke(configuration: &configuration::Configuration, payload: models::RelayUserRevokePayload) -> Result<models::RelaySessionBaseResponse, Error<RelayUserRevokeError>> {
    let local_var_configuration = configuration;
