...
pub fn lobby_create(configuration: &configuration::Configuration, payload: models::LobbyCreatePayload) -> Result<models::LobbyReadResponse, Error<LobbyCreateError>> {
...
pub fn lobby_delete(configuration: &configuration::Configuration, lobby_name: &str) -> Result<models::LobbyReadResponse, Error<LobbyDeleteError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/lobbies/{lobby_name}", local_var_configuration.base_path, lobby_name=crate::apis::urlencode(lobby_name));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text()?;
        let local_var_entity: Option<LobbyDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn lobby_deploy(configuration: &configuration::Configuration, payload: models::LobbyDeployPayload) -> Result<models::LobbyReadResponse, Error<LobbyDeployError>> {
    let local_var_configuration = configuration;
...
/// Get a named lobby.
pub fn lobby_get(configuration: &configuration::Configuration, lobby_name: &str) -> Result<models::LobbyReadResponse, Error<LobbyGetError>> {
    let local_var_configuration = configuration;
...
/// List the Lobbies
pub fn lobby_list(configuration: &configuration::Configuration, ) -> Result<models::LobbyReadResponse, Error<LobbyListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text()?;
        let local_var_entity: Option<LobbyListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn lobby_terminate(configuration: &configuration::Configuration, payload: models::LobbyTerminatePayload) -> Result<models::LobbyReadResponse, Error<LobbyTerminateError>> {
    let local_var_configuration = configuration;
