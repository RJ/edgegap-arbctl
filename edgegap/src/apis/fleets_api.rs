...
pub fn fleet_create(configuration: &configuration::Configuration, payload: models::FleetPostPayload) -> Result<models::FleetPostResponse, Error<FleetCreateError>> {
...
pub fn fleet_delete(configuration: &configuration::Configuration, fleet_name: &str) -> Result<models::FleetDeleteResponse, Error<FleetDeleteError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/fleet/{fleet_name}", local_var_configuration.base_path, fleet_name=crate::apis::urlencode(fleet_name));
...
pub fn fleet_get(configuration: &configuration::Configuration, fleet_name: &str) -> Result<models::FleetGetResponse, Error<FleetGetError>> {
    let local_var_configuration = configuration;
...
pub fn fleet_link_app_version(configuration: &configuration::Configuration, fleet_name: &str, app_name: &str, version_name: &str) -> Result<models::HorizontalScalerAppVersionLink, Error<FleetLinkAppVersionError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/fleet/{fleet_name}/app/{app_name}/version/{version_name}", local_var_configuration.base_path, fleet_name=crate::apis::urlencode(fleet_name), app_name=crate::apis::urlencode(app_name), version_name=crate::apis::urlencode(version_name));
...
pub fn fleet_policies_create(configuration: &configuration::Configuration, fleet_name: &str, payload: models::FleetPoliciesPostPayload) -> Result<models::FleetPoliciesPostResponse, Error<FleetPoliciesCreateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/fleet/{fleet_name}/policies", local_var_configuration.base_path, fleet_name=crate::apis::urlencode(fleet_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub fn fleet_policies_delete(configuration: &configuration::Configuration, fleet_name: &str, policy_name: &str) -> Result<(), Error<FleetPoliciesDeleteError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/fleet/{fleet_name}/policies/{policy_name}", local_var_configuration.base_path, fleet_name=crate::apis::urlencode(fleet_name), policy_name=crate::apis::urlencode(policy_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub fn fleet_policies_get(configuration: &configuration::Configuration, fleet_name: &str, policy_name: &str) -> Result<models::FleetPoliciesGetResponse, Error<FleetPoliciesGetError>> {
    let local_var_configuration = configuration;
...
pub fn fleet_policies_list(configuration: &configuration::Configuration, fleet_name: &str, page: Option<i32>, limit: Option<i32>, x_fields: Option<&str>) -> Result<models::HorizontalScalerConstraintList, Error<FleetPoliciesListError>> {
    let local_var_configuration = configuration;
...
pub fn fleet_policies_update(configuration: &configuration::Configuration, fleet_name: &str, policy_name: &str, payload: models::FleetPoliciesPatchPayload) -> Result<models::FleetPoliciesPatchPayload, Error<FleetPoliciesUpdateError>> {
    let local_var_configuration = configuration;
...
pub fn fleet_unlink_app_version(configuration: &configuration::Configuration, fleet_name: &str, app_name: &str, version_name: &str) -> Result<(), Error<FleetUnlinkAppVersionError>> {
    let local_var_configuration = configuration;
...
pub fn fleet_update(configuration: &configuration::Configuration, fleet_name: &str, payload: models::FleetPatchPayload) -> Result<models::FleetPatchResponse, Error<FleetUpdateError>> {
    let local_var_configuration = configuration;
...
pub fn fleets(configuration: &configuration::Configuration, page: Option<i32>, limit: Option<i32>) -> Result<models::FleetList, Error<FleetsError>> {
    let local_var_configuration = configuration;
