...
pub fn deploy(configuration: &configuration::Configuration, payload: models::DeployModel) -> Result<models::Request, Error<DeployError>> {
...
pub fn deployment_delete(configuration: &configuration::Configuration, request_id: &str, container_log_storage: Option<&str>) -> Result<models::Delete, Error<DeploymentDeleteError>> {
    let local_var_configuration = configuration;
...
pub fn deployment_get_logs(configuration: &configuration::Configuration, request_id: &str) -> Result<models::ApiModelContainerlogs, Error<DeploymentGetLogsError>> {
    let local_var_configuration = configuration;
...
pub fn deployment_status_get(configuration: &configuration::Configuration, request_id: &str) -> Result<models::Status, Error<DeploymentStatusGetError>> {
    let local_var_configuration = configuration;
...
pub fn deployment_update(configuration: &configuration::Configuration, request_id: &str, payload: models::DeploymentUpdatePayload) -> Result<models::DeploymentUpdateResponse, Error<DeploymentUpdateError>> {
    let local_var_configuration = configuration;
...
pub fn deployments_available(configuration: &configuration::Configuration, payload: models::DeploymentAvailablePayload) -> Result<models::DeploymentAvailableResponse, Error<DeploymentsAvailableError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v1/deployments:available", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_content = local_var_resp.text()?;
        let local_var_entity: Option<DeploymentsAvailableError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub fn deployments_bulk_delete(configuration: &configuration::Configuration, payload: models::DeploymentBulkStopPayload) -> Result<models::DeploymentBulkStopResponse, Error<DeploymentsBulkDeleteError>> {
    let local_var_configuration = configuration;
...
pub fn deployments_get(configuration: &configuration::Configuration, query: Option<&str>) -> Result<models::Deployments, Error<DeploymentsGetError>> {
    let local_var_configuration = configuration;
...
pub fn self_deployment_delete(configuration: &configuration::Configuration, request_id: &str, access_point_id: i32, authorization: &str, container_log_storage: Option<&str>) -> Result<models::Delete, Error<SelfDeploymentDeleteError>> {
    let local_var_configuration = configuration;
