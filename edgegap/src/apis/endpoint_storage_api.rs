...
pub fn endpoint_create(configuration: &configuration::Configuration, payload: models::EndpointStoragePostPayload) -> Result<models::EndpointStoragePostResponse, Error<EndpointCreateError>> {
...
pub fn endpoint_delete(configuration: &configuration::Configuration, endpoint_name: &str) -> Result<models::EndpointStorageDeleteResponse, Error<EndpointDeleteError>> {
    let local_var_configuration = configuration;
...
pub fn endpoint_get(configuration: &configuration::Configuration, endpoint_name: &str) -> Result<models::EndpointStorageGetResponse, Error<EndpointGetError>> {
    let local_var_configuration = configuration;
...
pub fn endpoint_update(configuration: &configuration::Configuration, endpoint_name: &str, payload: models::EndpointStoragePatchPayload) -> Result<models::EndpointStoragePatchResponse, Error<EndpointUpdateError>> {
    let local_var_configuration = configuration;
...
pub fn endpoints_list(configuration: &configuration::Configuration, page: Option<i32>, limit: Option<i32>, x_fields: Option<&str>) -> Result<models::EndpointStorageListResponse, Error<EndpointsListError>> {
    let local_var_configuration = configuration;
...
pub fn pull_profile_create(configuration: &configuration::Configuration, endpoint_name: &str, payload: models::PullProfilePostPayload) -> Result<models::PullProfilePostResponse, Error<PullProfileCreateError>> {
    let local_var_configuration = configuration;
...
pub fn pull_profile_delete(configuration: &configuration::Configuration, endpoint_name: &str, pull_profile_name: &str) -> Result<(), Error<PullProfileDeleteError>> {
    let local_var_configuration = configuration;
...
pub fn pull_profile_get(configuration: &configuration::Configuration, endpoint_name: &str, pull_profile_name: &str) -> Result<models::PullProfileGetResponse, Error<PullProfileGetError>> {
    let local_var_configuration = configuration;
...
pub fn pull_profile_link_app_version(configuration: &configuration::Configuration, endpoint_name: &str, pull_profile_name: &str, app_name: &str, version_name: &str) -> Result<models::PullProfileAppVersionLinkResponse, Error<PullProfileLinkAppVersionError>> {
    let local_var_configuration = configuration;
...
pub fn pull_profile_list(configuration: &configuration::Configuration, endpoint_name: &str, page: Option<i32>, limit: Option<i32>) -> Result<models::PullProfilesListResponse, Error<PullProfileListError>> {
    let local_var_configuration = configuration;
...
pub fn pull_profile_unlink_app_version(configuration: &configuration::Configuration, endpoint_name: &str, pull_profile_name: &str, app_name: &str, version_name: &str) -> Result<(), Error<PullProfileUnlinkAppVersionError>> {
    let local_var_configuration = configuration;
...
pub fn pull_profile_update(configuration: &configuration::Configuration, endpoint_name: &str, pull_profile_name: &str, payload: models::PullProfilePatchPayload) -> Result<models::PulloProfilePatchResponse, Error<PullProfileUpdateError>> {
    let local_var_configuration = configuration;
